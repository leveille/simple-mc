...
<html>
    <head>
        ...
        <meta name="copyright" content="http://blueatlas.com">
    ...
    <body>
        <div id="doc" class="yui-t5">
            ...
            <div id="hd">
                ...
                <div id="logo">
                    <h1>h1: Client Name</h1>
                    <p>p: Motto/subheading/mantra/etc</p>
                </div>
        ...
        <script type="text/javascript">
            //A quick check to see if we are on a page that requires flash replacement
            //id-to-replace should be replaced with the id of the div/element to replace
            if ($('#id-to-replace').length > 0) {
                //jquery specific code here.  If not including the jquery library in a project this
                //will need modification/removal.  Also, thought will need to be put into the instance
                //when there are multiple swf files that need to be served throughout the site
                $.getScript("/javascripts/swfobject/swfobject.js", function(){
                    var flashvars = {};
                    var params = {
                    ...
                    var attributes = {};
                    swfobject.embedSWF('/local/path/to/swf', "id-to-replace", "width", "height", "9.0.0", null, flashvars, params, attributes);
                });
            }
        </script>
    </body>
