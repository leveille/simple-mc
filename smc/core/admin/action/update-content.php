<?php
/* SVN FILE: $Id: update-content.php 110 2008-08-07 14:50:23Z leveillej $ */
/**
*
...
*/
    ...
    if(isset($_POST['cId'])) {
        try {
            ...
            $block->blockUpdateAll($cId, $markup, $cDescription);
            echo "{'success' : true}" ;
        } catch (Exception $e) {
            echo "{'success' : false}" ;
        }
    } else {
        echo "{success : false, msg : 'Data must be submitted in order to update this content block.'}" ;
    }